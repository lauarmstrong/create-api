...
var store = new person_1.PersonStore();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.create(person)];
            case 2:
                newPerson = _a.sent();
                res.json(newPerson);
                return [3 /*break*/, 4];
