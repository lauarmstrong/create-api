        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Cannot get products, Error: ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO products (name, price, imageUrl, productCode) VALUES($1, $2, $3, $4) RETURNING *";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not add new product ".concat(name, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
